...
assert.equal(NAV_META.general2DNavmesh,false);assert.equal(NAV_META.persistentWaypoints,true);assert.equal(NAV_META.smoothedSteering,true);console.log('PASS navigation metadata accurately describes the side-view planner');
